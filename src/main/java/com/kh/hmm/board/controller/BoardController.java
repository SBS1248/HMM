...
public class BoardController {
	...
	public String selectBoardList(HttpServletRequest request, Model model, int dis) {
	...
	/*
	 * @RequestMapping(value = "boardInsert.do", method = RequestMethod.POST) public
	 * void insertBoard(Board b, HttpServletResponse response) throws IOException
	 * {//아작스 처리를 요한다. logger.info("insertBoard("+b+") call..."); PrintWriter pw =
	 * response.getWriter(); pw.write(boardService.insertBoard(b)); pw.close(); }
	 * 
	 * @RequestMapping(value = "boardUpdate.do", method = RequestMethod.POST) public
	 * int updateBoard(Board b) {//아작스 처리를 요한다.
