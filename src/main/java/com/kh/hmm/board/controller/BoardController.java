...
public class BoardController {
	...
	public String selectBoardOne(HttpServletRequest request,Model model,int bcode) 
	{
	...
	public void insertBoard(Board b, HttpServletResponse response) throws IOException {// 아작스 처리를 요한다.
	...
	public int updateBoard(Board b) {// 아작스 처리를 요한다.
