		...
		<div class="board-body">
					...
					<div class="hmm_table">
						<table id="myTable" style="background: white;">
							...
							<tr>
							<td style="text-align: center; background: #97cbff;" name="test_check" colspan="5" id="bwhidden${status.index}" class="hidden">${s.sercontent}</td>
							</tr>		
							</c:forEach>
					...
					<%-- 페이지 처리 --%>				
				 	<tr align="center" height="20">
						...
						<button onclick="checkAll(${slsize})" class="button5">전체 선택  & 해제</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<button onclick="ch()" class="button5">체크 된 목록 삭제</button>
						</div>
			</div>
				</div>
